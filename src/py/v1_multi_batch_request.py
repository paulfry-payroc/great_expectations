...
def create_and_run_checkpoint(batch_request, expectation_suite_name):
    ...
    context.build_data_docs()  # TODO - circle back to this, if it needs to be done in parallel
...
def prepare_batch_request(input_table, gx_data_src_name, row_count_limit):
    ...
    batch_request = {
        "datasource_name": gx_data_src_name,
        "data_connector_name": "default_configured_data_connector_name",
        "data_asset_name": input_table,
        "limit": int(row_count_limit),
    }
